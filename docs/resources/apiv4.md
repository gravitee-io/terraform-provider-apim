...
page_title: "gravitee-apim_apiv4 Resource - terraform-provider-gravitee-apim"
subcategory: ""
description: |-
  Apiv4 Resource
---

# gravitee-apim_apiv4 (Resource)
...
- `config_type` (String) Not Null; must be one of ["PORTAL", "GENERIC"]
...
```shell
terraform import gravitee-apim_apiv4.my_gravitee-apim_apiv4 '{"environment_id": "", "hrid": "", "organization_id": ""}'
```
