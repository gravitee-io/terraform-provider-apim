...
page_title: "gravitee-apim_shared_policy_group Resource - terraform-provider-gravitee-apim"
subcategory: ""
description: |-
  SharedPolicyGroup Resource
---

# gravitee-apim_shared_policy_group (Resource)
...
```shell
terraform import gravitee-apim_shared_policy_group.my_gravitee-apim_shared_policy_group '{"environment_id": "", "hrid": "", "organization_id": ""}'
```
