...
- `groups` (List of String) List of groups associated with the Application. This groups are UUID of existing groups in APIM.
- `members` (Attributes List) Users that can manage this application (see [below for nested schema](#nestedatt--members))
