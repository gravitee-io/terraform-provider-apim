...
.PHONY: test-examples
test-examples: ## Run acceptance tests against a running environment
	@APIM_USERNAME=${APIM_USERNAME} APIM_PASSWORD=${APIM_PASSWORD} APIM_SERVER_URL=${APIM_SERVER_URL} ./tests/examples/list_and_run.sh
