...
// Generated from OpenAPI doc version 1.0.0 and generator version 2.656.9
...
// GraviteeApim - Gravitee.io - Automation API: The APIM automation API.
...
func New(opts ...SDKOption) *GraviteeApim {
	sdk := &GraviteeApim{
		SDKVersion: "0.1.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.1.2 2.656.9 1.0.0 github.com/speakeasy/terraform-provider-gravitee-apim/internal/sdk",
