...
// Generated from OpenAPI doc version 1.0.0 and generator version 2.698.0
...
func New(opts ...SDKOption) *GraviteeApim {
	sdk := &GraviteeApim{
		SDKVersion: "0.3.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.3.0 2.698.0 1.0.0 github.com/gravitee-io/terraform-provider-apim/internal/sdk",
