...
// Generated from OpenAPI doc version 0.2.0 and generator version 2.657.1
...
func New(opts ...SDKOption) *GraviteeApim {
	sdk := &GraviteeApim{
		SDKVersion: "4.8.0-alpha.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 4.8.0-alpha.2 2.657.1 0.2.0 github.com/gravitee-io/terraform-provider-apim/v4/internal/sdk",
