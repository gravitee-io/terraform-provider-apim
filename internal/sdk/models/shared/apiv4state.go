...
type APIV4State struct {
	...
	// API's version. It's a simple string only used to help manage API versionning.
	...
	// Common endpoints properties and container of endpoints specifiing backends this API can call.
	...
	// Flows for the API where traffic policies are configured.
	...
	// UUIDs of existing groups (of users) associated with this API.
	Groups []string `json:"groups,omitempty"`
	// The visibility of the entity regarding the portal.
	Visibility *Visibility `default:"PUBLIC" json:"visibility"`
	// The desired state of the API. Switching states between STOPPED and STARTED will effectively deploy the API and vice-versa.
	...
	// The list of category UUID associated with this API.
	Categories []string `json:"categories,omitempty"`
	// Users can manage the API.
