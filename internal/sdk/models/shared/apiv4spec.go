...
func (a *APIV4Spec) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &a, "", false, []string{"hrid", "definitionContext", "name", "version", "type", "listeners", "endpointGroups", "lifecycleState"}); err != nil {
		return err
	}
	return nil
}
...
func (a *APIV4Spec) GetDefinitionContext() DefinitionContext {
	if a == nil {
		return DefinitionContext{}
	}
	return a.DefinitionContext
}
...
func (a *APIV4Spec) GetPlans() map[string]PlanInput {
	if a == nil {
		return nil
	}
	return a.Plans
...
func (a *APIV4Spec) GetFlows() []FlowV4Input {
	if a == nil {
		return nil
	}
	return a.Flows
