...
// @generated-id: 2cb14b05e4a0

package shared

// DocumentationSpec - Specification of a Documentation page.
...
func (d *DocumentationSpec) GetHrid() string {
	if d == nil {
		return ""
	}
	return d.Hrid
...
func (d *DocumentationSpec) GetName() string {
	if d == nil {
		return ""
	}
	return d.Name
...
func (d *DocumentationSpec) GetType() DocumentationType {
	if d == nil {
...
func (d *DocumentationSpec) GetContent() string {
	if d == nil {
		return ""
	}
	return d.Content
...
func (d *DocumentationSpec) GetLocation() *string {
	if d == nil {
		return nil
	}
	return d.Location
...
func (d *DocumentationSpec) GetOrder() *int64 {
	if d == nil {
		return nil
	}
	return d.Order
