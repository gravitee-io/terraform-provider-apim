...
type DeletePortalGlobals struct {
	// organization ID
...
func (d DeletePortalGlobals) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeletePortalGlobals) UnmarshalJSON(data []byte) error {
...
func (d *DeletePortalGlobals) GetOrganizationID() *string {
	if d == nil {
		return nil
	}
...
func (d *DeletePortalGlobals) GetEnvironmentID() *string {
	if d == nil {
		return nil
	}
...
func (d *DeletePortalRequest) GetOrganizationID() *string {
	if d == nil {
		return nil
	}
	return d.OrganizationID
...
func (d *DeletePortalRequest) GetEnvironmentID() *string {
	if d == nil {
		return nil
	}
	return d.EnvironmentID
...
func (d *DeletePortalRequest) GetHrid() string {
	if d == nil {
		return ""
	}
	return d.Hrid
...
func (d *DeletePortalResponse) GetHTTPError() *shared.HTTPError {
	if d == nil {
		return nil
	}
	return d.HTTPError
...
func (d *DeletePortalResponse) GetError() *shared.Error {
	if d == nil {
		return nil
	}
	return d.Error
