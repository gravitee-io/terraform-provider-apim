...
// Dictionaries - Everything about Dictionaries
...
func newDictionaries(rootSDK *GraviteeApim, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Dictionaries {
	return &Dictionaries{
		rootSDK:          rootSDK,
...
func (s *Dictionaries) CreateOrUpdateDictionaries(ctx context.Context, request operations.CreateOrUpdateDictionariesRequest, opts ...operations.Option) (*operations.CreateOrUpdateDictionariesResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/organizations/{orgId}/environments/{envId}/dictionaries", request, globals)
	if err != nil {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "DictionarySpec", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.CreateOrUpdateDictionariesResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.DictionaryState
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.DictionaryState = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Dictionaries) GetDictionary(ctx context.Context, request operations.GetDictionaryRequest, opts ...operations.Option) (*operations.GetDictionaryResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/organizations/{orgId}/environments/{envId}/dictionaries/{hrid}", request, globals)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
