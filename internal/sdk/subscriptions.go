...
// Create or update Subscription from SubscriptionSpec
func (s *Subscriptions) CreateOrUpdate(ctx context.Context, request operations.CreateOrUpdateSubscriptionsRequest, opts ...operations.Option) (*operations.CreateOrUpdateSubscriptionsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/organizations/{orgId}/environments/{envId}/subscriptions", request, nil)
	if err != nil {
...
func (s *Subscriptions) Get(ctx context.Context, request operations.GetSubscriptionRequest, opts ...operations.Option) (*operations.GetSubscriptionResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/organizations/{orgId}/environments/{envId}/subscriptions/{hrid}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
