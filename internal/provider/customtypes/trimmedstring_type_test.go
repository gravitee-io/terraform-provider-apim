...
func TestTrimmedStringTypeValueFromTerraform(t *testing.T) {
	t.Parallel()
	...
	testCases := map[string]struct {
		...
		"true": {
			...
			expectation: customtypes.NewTrimmedStringValue("hello world"),
		},
		"unknown": {
			in:          tftypes.NewValue(tftypes.String, tftypes.UnknownValue),
			expectation: customtypes.NewTrimmedStringUnknown(),
		},
		"null": {
			in:          tftypes.NewValue(tftypes.String, nil),
			expectation: customtypes.NewTrimmedStringNull(),
		},
		"wrongType": {
	...
	for name, testCase := range testCases {
		...
		t.Run(name, func(t *testing.T) {
			...
			got, err := customtypes.TrimmedStringType{}.ValueFromTerraform(ctx, testCase.in)
			if err != nil {
