...
func TestRFC3339_StringSemanticEquals(t *testing.T) {
	...
	testCases := map[string]struct {
		currentRFC3339time customtypes.RFC3339
		givenRFC3339time   basetypes.StringValuable
		expectedMatch      bool
		expectedDiags      diag.Diagnostics
	}{
		"not equal - different dates": {
			currentRFC3339time: customtypes.NewRFC3339ValueMust("2023-07-25T23:43:16Z"),
			givenRFC3339time:   customtypes.NewRFC3339ValueMust("2023-07-26T23:43:16Z"),
			expectedMatch:      false,
		},
		"not equal - different times": {
			currentRFC3339time: customtypes.NewRFC3339ValueMust("2023-07-25T23:43:16Z"),
			givenRFC3339time:   customtypes.NewRFC3339ValueMust("2023-07-25T23:01:16Z"),
			expectedMatch:      false,
		},
		"not equal - different offset times": {
			currentRFC3339time: customtypes.NewRFC3339ValueMust("2023-07-25T23:43:16Z"),
			givenRFC3339time:   customtypes.NewRFC3339ValueMust("2023-07-25T23:43:16+03:00"),
			expectedMatch:      false,
		},
		"semantically equal - UTC time and local time": {
			currentRFC3339time: customtypes.NewRFC3339ValueMust("2023-07-25T23:43:16Z"),
			givenRFC3339time:   customtypes.NewRFC3339ValueMust("2023-07-25T20:43:16-03:00"),
			expectedMatch:      true,
		}, "semantically equal - same time on different offsets local time": {
			currentRFC3339time: customtypes.NewRFC3339ValueMust("2023-07-26T02:43:16+03:00"),
			givenRFC3339time:   customtypes.NewRFC3339ValueMust("2023-07-25T20:43:16-03:00"),
			expectedMatch:      true,
		},
		"semantically equal - Z suffix and positive zero num offset": {
			currentRFC3339time: customtypes.NewRFC3339ValueMust("2023-07-25T23:43:16Z"),
			givenRFC3339time:   customtypes.NewRFC3339ValueMust("2023-07-25T23:43:16+00:00"),
			expectedMatch:      true,
		},
		...
		"semantically equal - negative zero and positive zero num offset": {
			currentRFC3339time: customtypes.NewRFC3339ValueMust("2023-07-25T23:43:16-00:00"),
			givenRFC3339time:   customtypes.NewRFC3339ValueMust("2023-07-25T23:43:16+00:00"),
			expectedMatch:      true,
		},
		"semantically equal - byte for byte match": {
			currentRFC3339time: customtypes.NewRFC3339ValueMust("2023-07-25T23:43:16Z"),
			givenRFC3339time:   customtypes.NewRFC3339ValueMust("2023-07-25T23:43:16Z"),
			expectedMatch:      true,
		},
			...
			expectedDiags: diag.Diagnostics{
				diag.NewErrorDiagnostic(
					...
					"An unexpected value type was received while performing semantic equality checks. "+
						...
						"Expected Value Type: customtypes.RFC3339\n"+
...
func TestRFC3339ValidateAttribute(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"null": {
			RFC3339: customtypes.NewRFC3339Null(),
		},
		"unknown": {
			RFC3339: customtypes.NewRFC3339Unknown(),
		},
		"valid RFC3339": {
			RFC3339: customtypes.NewRFC3339ValueMust("2023-07-25T20:43:16+00:00"),
		},
		"valid RFC3339 - Zulu": {
			RFC3339: customtypes.NewRFC3339ValueMust("2023-07-25T20:43:16Z"),
		},
		"valid RFC3339 - UTC Offset": {
			RFC3339: customtypes.NewRFC3339ValueMust("2023-07-25T20:43:16-05:00"),
		},
...
func TestRFC3339_ValueRFC3339Time(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"valid RFC3339 Timestamp - Zulu suffix": {
			RFC3339:           customtypes.NewRFC3339ValueMust("2023-07-25T23:43:16Z"),
			expectedTimestamp: "2023-07-25T23:43:16Z",
		},
		"valid RFC3339 Timestamp - UTC offset ": {
			RFC3339:           customtypes.NewRFC3339ValueMust("2023-07-25T23:43:16-00:00"),
			expectedTimestamp: "2023-07-25T23:43:16-00:00",
		},
		"valid RFC3339 Timestamp - EDT offset ": {
			RFC3339:           customtypes.NewRFC3339ValueMust("2023-07-25T23:43:16-04:00"),
