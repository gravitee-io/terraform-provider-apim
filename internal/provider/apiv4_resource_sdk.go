...
import (
	"context"
	"encoding/json"
	"github.com/gravitee-io/terraform-provider-apim/v4/internal/provider/typeconvert"
...
func (r *Apiv4ResourceModel) RefreshFromSharedApiv4State(ctx context.Context, resp *shared.APIV4State) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.ConsoleNotificationConfiguration == nil {
			r.ConsoleNotificationConfiguration = nil
		} else {
			r.ConsoleNotificationConfiguration = &tfTypes.PortalNotificationConfig{}
			r.ConsoleNotificationConfiguration.ConfigType = types.StringValue(string(resp.ConsoleNotificationConfiguration.ConfigType))
			r.ConsoleNotificationConfiguration.Groups = make([]types.String, 0, len(resp.ConsoleNotificationConfiguration.Groups))
			for _, v := range resp.ConsoleNotificationConfiguration.Groups {
				r.ConsoleNotificationConfiguration.Groups = append(r.ConsoleNotificationConfiguration.Groups, types.StringValue(v))
			}
			r.ConsoleNotificationConfiguration.Hooks = make([]types.String, 0, len(resp.ConsoleNotificationConfiguration.Hooks))
			for _, v := range resp.ConsoleNotificationConfiguration.Hooks {
				r.ConsoleNotificationConfiguration.Hooks = append(r.ConsoleNotificationConfiguration.Hooks, types.StringValue(v))
			}
			r.ConsoleNotificationConfiguration.Name = types.StringValue(resp.ConsoleNotificationConfiguration.Name)
			r.ConsoleNotificationConfiguration.ReferenceID = types.StringPointerValue(resp.ConsoleNotificationConfiguration.ReferenceID)
			r.ConsoleNotificationConfiguration.ReferenceType = types.StringPointerValue(resp.ConsoleNotificationConfiguration.ReferenceType)
			r.ConsoleNotificationConfiguration.User = types.StringPointerValue(resp.ConsoleNotificationConfiguration.User)
		}
...
func (r *Apiv4ResourceModel) ToSharedApiv4Spec(ctx context.Context) (*shared.APIV4Spec, diag.Diagnostics) {
	...
	definitionContext := shared.DefinitionContext{}
	var name string
	...
	for _, listenersItem := range r.Listeners {
		if listenersItem.HTTP != nil {
			...
			pathMappings := make([]string, 0, len(listenersItem.HTTP.PathMappings))
			for _, pathMappingsItem := range listenersItem.HTTP.PathMappings {
				pathMappings = append(pathMappings, pathMappingsItem.ValueString())
			}
			...
			if listenersItem.HTTP.Cors != nil {
				...
				allowMethods := make([]string, 0, len(listenersItem.HTTP.Cors.AllowMethods))
				for _, allowMethodsItem := range listenersItem.HTTP.Cors.AllowMethods {
					allowMethods = append(allowMethods, allowMethodsItem.ValueString())
				}
		...
		if listenersItem.Kafka != nil {
			...
			port := new(int64)
			if !listenersItem.Kafka.Port.IsUnknown() && !listenersItem.Kafka.Port.IsNull() {
				*port = listenersItem.Kafka.Port.ValueInt64()
			} else {
				port = nil
			}
	...
	for _, endpointGroupsItem := range r.EndpointGroups {
		...
		for _, endpointsItem := range endpointGroupsItem.Endpoints {
			...
			if endpointsItem.Services != nil {
				...
				if endpointsItem.Services.HealthCheck != nil {
					...
					if !endpointsItem.Services.HealthCheck.Configuration.IsUnknown() && !endpointsItem.Services.HealthCheck.Configuration.IsNull() {
					...
					typeVar6 := new(string)
					if !endpointsItem.Services.HealthCheck.Type.IsUnknown() && !endpointsItem.Services.HealthCheck.Type.IsNull() {
		...
		if endpointGroupsItem.Services != nil {
			...
			if endpointGroupsItem.Services.Discovery != nil {
				...
				if !endpointGroupsItem.Services.Discovery.Configuration.IsUnknown() && !endpointGroupsItem.Services.Discovery.Configuration.IsNull() {
				...
				typeVar7 := new(string)
				if !endpointGroupsItem.Services.Discovery.Type.IsUnknown() && !endpointGroupsItem.Services.Discovery.Type.IsNull() {
			...
			if endpointGroupsItem.Services.HealthCheck != nil {
				...
				if !endpointGroupsItem.Services.HealthCheck.Configuration.IsUnknown() && !endpointGroupsItem.Services.HealthCheck.Configuration.IsNull() {
				...
				typeVar8 := new(string)
				if !endpointGroupsItem.Services.HealthCheck.Type.IsUnknown() && !endpointGroupsItem.Services.HealthCheck.Type.IsNull() {
	...
	properties := make([]shared.Property, 0, len(r.Properties))
	for _, propertiesItem := range r.Properties {
		...
		encrypted := new(bool)
		if !propertiesItem.Encrypted.IsUnknown() && !propertiesItem.Encrypted.IsNull() {
			*encrypted = propertiesItem.Encrypted.ValueBool()
		} else {
			encrypted = nil
		}
		dynamic := new(bool)
		...
		properties = append(properties, shared.Property{
			Key:         key,
			Value:       value1,
			Encrypted:   encrypted,
			Dynamic:     dynamic,
	...
	resources := make([]shared.Resource, 0, len(r.Resources))
	...
	plans := make(map[string]shared.PlanInput)
	for plansKey, plansValue := range r.Plans {
		name4 := new(string)
		if !plansValue.Name.IsUnknown() && !plansValue.Name.IsNull() {
			*name4 = plansValue.Name.ValueString()
		} else {
			name4 = nil
		}
		description1 := new(string)
		if !plansValue.Description.IsUnknown() && !plansValue.Description.IsNull() {
			*description1 = plansValue.Description.ValueString()
		} else {
			description1 = nil
		}
		var security *shared.PlanSecurity
		if plansValue.Security != nil {
			typeVar10 := shared.PlanSecurityType(plansValue.Security.Type.ValueString())
			var configuration9 interface{}
			if !plansValue.Security.Configuration.IsUnknown() && !plansValue.Security.Configuration.IsNull() {
				_ = json.Unmarshal([]byte(plansValue.Security.Configuration.ValueString()), &configuration9)
			}
		...
		characteristics := make([]string, 0, len(plansValue.Characteristics))
		for _, characteristicsItem := range plansValue.Characteristics {
			characteristics = append(characteristics, characteristicsItem.ValueString())
		}
		excludedGroups := make([]string, 0, len(plansValue.ExcludedGroups))
		for _, excludedGroupsItem := range plansValue.ExcludedGroups {
			excludedGroups = append(excludedGroups, excludedGroupsItem.ValueString())
		}
		generalConditions := new(string)
		if !plansValue.GeneralConditions.IsUnknown() && !plansValue.GeneralConditions.IsNull() {
			*generalConditions = plansValue.GeneralConditions.ValueString()
		} else {
			generalConditions = nil
		}
		selectionRule := new(string)
		if !plansValue.SelectionRule.IsUnknown() && !plansValue.SelectionRule.IsNull() {
			*selectionRule = plansValue.SelectionRule.ValueString()
		} else {
			selectionRule = nil
		}
		status := shared.PlanStatus(plansValue.Status.ValueString())
		tags1 := make([]string, 0, len(plansValue.Tags))
		for _, tagsItem1 := range plansValue.Tags {
			tags1 = append(tags1, tagsItem1.ValueString())
		}
		typeVar11 := shared.PlanType(plansValue.Type.ValueString())
		validation := new(shared.PlanValidation)
		if !plansValue.Validation.IsUnknown() && !plansValue.Validation.IsNull() {
			*validation = shared.PlanValidation(plansValue.Validation.ValueString())
		} else {
			validation = nil
		}
		flows := make([]shared.FlowV4Input, 0, len(plansValue.Flows))
		for _, flowsItem := range plansValue.Flows {
			name5 := new(string)
			...
			for _, selectorsItem := range flowsItem.Selectors {
				if selectorsItem.HTTP != nil {
					typeVar12 := shared.HTTPSelectorType(selectorsItem.HTTP.Type.ValueString())
					path1 := new(string)
				...
				if selectorsItem.Channel != nil {
					typeVar13 := shared.ChannelSelectorType(selectorsItem.Channel.Type.ValueString())
				...
				if selectorsItem.Condition != nil {
					typeVar14 := shared.ConditionSelectorType(selectorsItem.Condition.Type.ValueString())
			...
			flows = append(flows, shared.FlowV4Input{
				Name:      name5,
				Enabled:   enabled8,
				Selectors: selectors,
				Request:   request1,
		...
		mode1 := shared.PlanMode(plansValue.Mode.ValueString())
		plansInst := shared.PlanInput{
			Name:              name4,
	...
	flows1 := make([]shared.FlowV4Input, 0, len(r.Flows))
	for _, flowsItem1 := range r.Flows {
		...
		for _, selectorsItem1 := range flowsItem1.Selectors {
			if selectorsItem1.HTTP != nil {
				typeVar15 := shared.HTTPSelectorType(selectorsItem1.HTTP.Type.ValueString())
				path2 := new(string)
			...
			if selectorsItem1.Channel != nil {
				typeVar16 := shared.ChannelSelectorType(selectorsItem1.Channel.Type.ValueString())
			...
			if selectorsItem1.Condition != nil {
				typeVar17 := shared.ConditionSelectorType(selectorsItem1.Condition.Type.ValueString())
		...
		flows1 = append(flows1, shared.FlowV4Input{
			Name:      name12,
			Enabled:   enabled15,
	...
	if r.Services != nil {
		...
		if r.Services.DynamicProperty != nil {
			...
			if !r.Services.DynamicProperty.Configuration.IsUnknown() && !r.Services.DynamicProperty.Configuration.IsNull() {
			...
			if !r.Services.DynamicProperty.Type.IsUnknown() && !r.Services.DynamicProperty.Type.IsNull() {
				*typeVar18 = r.Services.DynamicProperty.Type.ValueString()
			} else {
				typeVar18 = nil
			}
	...
	if r.PrimaryOwner != nil {
		...
		typeVar19 := new(shared.MembershipMemberType)
		if !r.PrimaryOwner.Type.IsUnknown() && !r.PrimaryOwner.Type.IsNull() {
			*typeVar19 = shared.MembershipMemberType(r.PrimaryOwner.Type.ValueString())
		} else {
			typeVar19 = nil
		}
	...
	for _, metadataItem := range r.Metadata {
		...
		if !metadataItem.Key.IsUnknown() && !metadataItem.Key.IsNull() {
			*key1 = metadataItem.Key.ValueString()
		} else {
			key1 = nil
		}
		name19 := new(string)
	...
	var consoleNotificationConfiguration *shared.PortalNotificationConfig
	if r.ConsoleNotificationConfiguration != nil {
		configType := shared.ConfigType(r.ConsoleNotificationConfiguration.ConfigType.ValueString())
		var name20 string
		name20 = r.ConsoleNotificationConfiguration.Name.ValueString()

		referenceType := new(string)
		if !r.ConsoleNotificationConfiguration.ReferenceType.IsUnknown() && !r.ConsoleNotificationConfiguration.ReferenceType.IsNull() {
			*referenceType = r.ConsoleNotificationConfiguration.ReferenceType.ValueString()
		} else {
			referenceType = nil
		}
		referenceID := new(string)
		if !r.ConsoleNotificationConfiguration.ReferenceID.IsUnknown() && !r.ConsoleNotificationConfiguration.ReferenceID.IsNull() {
			*referenceID = r.ConsoleNotificationConfiguration.ReferenceID.ValueString()
		} else {
			referenceID = nil
		}
		user := new(string)
		if !r.ConsoleNotificationConfiguration.User.IsUnknown() && !r.ConsoleNotificationConfiguration.User.IsNull() {
			*user = r.ConsoleNotificationConfiguration.User.ValueString()
		} else {
			user = nil
		}
		hooks := make([]string, 0, len(r.ConsoleNotificationConfiguration.Hooks))
		for _, hooksItem := range r.ConsoleNotificationConfiguration.Hooks {
			hooks = append(hooks, hooksItem.ValueString())
		}
		groups1 := make([]string, 0, len(r.ConsoleNotificationConfiguration.Groups))
		for _, groupsItem1 := range r.ConsoleNotificationConfiguration.Groups {
			groups1 = append(groups1, groupsItem1.ValueString())
		}
		consoleNotificationConfiguration = &shared.PortalNotificationConfig{
