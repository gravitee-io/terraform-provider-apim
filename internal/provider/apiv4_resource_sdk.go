	...
	for flowsIndex1 := range r.Flows {
		...
		for selectorsItem1 := range r.Flows[flowsIndex1].Selectors {
			if r.Flows[flowsIndex1].Selectors[selectorsItem1].HTTP != nil {
				typeVar14 := shared.HTTPSelectorType(r.Flows[flowsIndex1].Selectors[selectorsItem1].HTTP.Type.ValueString())
				path2 := new(string)
				...
				methods1 := make([]shared.HTTPMethod, 0, len(r.Flows[flowsIndex1].Selectors[selectorsItem1].HTTP.Methods))
			...
			if r.Flows[flowsIndex1].Selectors[selectorsItem1].Channel != nil {
				typeVar15 := shared.ChannelSelectorType(r.Flows[flowsIndex1].Selectors[selectorsItem1].Channel.Type.ValueString())
			...
			if r.Flows[flowsIndex1].Selectors[selectorsItem1].Condition != nil {
				typeVar16 := shared.ConditionSelectorType(r.Flows[flowsIndex1].Selectors[selectorsItem1].Condition.Type.ValueString())
	...
	for pagesIndex := range r.Pages {
		...
		if r.Pages[pagesIndex].Source != nil {
			...
			if !r.Pages[pagesIndex].Source.Type.IsUnknown() && !r.Pages[pagesIndex].Source.Type.IsNull() {
				*typeVar19 = r.Pages[pagesIndex].Source.Type.ValueString()
			} else {
				typeVar19 = nil
			}
